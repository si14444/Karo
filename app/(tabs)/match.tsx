...
export default function MatchScreen() {
  ...
  const tabs = [
    ...
    { id: "join", label: "방 참가" },
    { id: "live", label: "라이브 경기" },
  ];

  // Main tab state
  const [activeTab, setActiveTab] = useState<"create" | "join" | "live">(
    "create"
  );
  ...
  const handleSubmitScore = () => {
    ...
    const winnerId =
      score1 > score2 ? currentMatch.player1Id : currentMatch.player2Id;
    const result = {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <TabSelector
        ...
        activeTab={activeTab}
        onTabChange={(tabId) =>
          setActiveTab(tabId as "create" | "join" | "live")
        }
      />
            ...
            {!createdRoom ? (
              <>
                ...
                <View style={styles.formGroup}>
                  ...
                  >
                    ...
                    />
                    <Text
                      style={[styles.inputButtonText, { color: colors.text }]}
                    >
              ...
              >
                <View style={styles.roomHeader}>
                  ...
                  <Text style={[styles.roomStatus, { color: colors.tint }]}>
                    대기 중
                  </Text>
                </View>

                <View style={styles.roomInfo}>
                  <Text style={[styles.roomPlace, { color: colors.text }]}>
                    📍 {createdRoom.place}
                  </Text>
                  <Text
                    style={[styles.roomDate, { color: colors.tabIconDefault }]}
                  >
                ...
                >
                  ...
                  <Text style={[styles.inviteCode, { color: colors.tint }]}>
            ...
            {!joinedRoom ? (
              ...
              >
                <View style={styles.roomHeader}>
                  ...
                  <Text
                    style={[styles.roomStatus, { color: colors.secondary }]}
                  >
                    준비 완료
                  </Text>
                </View>
                ...
                <View style={styles.playersInfo}>
                  ...
                  <Text
                    style={[styles.playersText, { color: colors.secondary }]}
                  >
                    {getUserNickname(joinedRoom.hostId)} vs{" "}
                    {getUserNickname(joinedRoom.guestId || "")}
                  </Text>
                </View>

                <Text
                  style={[styles.waitingText, { color: colors.tabIconDefault }]}
                >
          ...
          <View style={styles.formContainer}>
            {!currentMatch ? (
              <EmptyState
                ...
                subtitle="방을 만들거나 입장하여 경기를 시작하세요"
              />
            ) : (
              <View
                style={[
              ...
              >
                <Text style={[styles.liveTitle, { color: colors.secondary }]}>
                  🔴 라이브 경기
                </Text>
                ...
                <View style={styles.liveMatchInfo}>
                  <Text style={[styles.livePlace, { color: colors.text }]}>
                    📍 {currentMatch.place}
                  </Text>
                  <Text style={[styles.livePlayers, { color: colors.text }]}>
                    🏀 {getUserNickname(currentMatch.player1Id)} vs{" "}
                    {getUserNickname(currentMatch.player2Id)}
                  </Text>
                  <Text
                    style={[styles.liveStatus, { color: colors.secondary }]}
                  >
                ...
                {currentMatch.status === "in_progress" && (
                  ...
                  >
                    ...
                    <Text
                      style={[styles.endButtonText, { color: colors.text }]}
                    >
                      경기 종료
                    </Text>
                  </TouchableOpacity>
      ...
      <Modal visible={showScoreModal} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View
            style={[
              styles.scoreModalContent,
              { backgroundColor: colors.surface },
            ]}
          >
            <Text style={[styles.scoreModalTitle, { color: colors.secondary }]}>
              경기 결과 입력
            </Text>
            ...
            <View style={styles.scoreModalButtons}>
              ...
              >
                <Text
                  style={[styles.scoreModalButtonText, { color: colors.text }]}
                >
                  취소
                </Text>
              </TouchableOpacity>
